...
if ($busqueda !== "") {
    $sqlExpedientes .= "
        AND (
            ...
            OR (
                CASE
                    WHEN e.origen_documento = 'INTERNO' THEN 'Interno'
                    WHEN e.origen_documento = 'EXTERNO' THEN 'Externo'
                    ELSE e.origen_documento
                END
            ) LIKE ?
        )
    ";
                ...
                >
                    ...
                    <div class="filter-group">
                        ...
                        <input
                            ...
                            id="buscar"
                            name="buscar"
                            placeholder="Buscar por número, tipo, remitente, asunto u origen..."
