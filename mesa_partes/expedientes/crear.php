            ...
            >
                ...
                <section class="expediente-form-card">
                    ...
                    <div class="expediente-card-header">
                        ...
                        <div>
                            ...
                            <p>
                                Adjunta el documento principal (PDF) si lo tienes disponible.
                                Este campo es opcional: puedes guardar el registro sin archivo digital.
                            </p>
                ...
                <div class="expediente-form-actions" style="flex-wrap: wrap; gap: 12px; align-items: center;">
                    ...
                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; margin-right: auto;">
                        <input type="checkbox" name="imprimir_al_guardar" id="imprimir_al_guardar" value="1">
                        <span>Imprimir documento al guardar (opcional)</span>
                    </label>
