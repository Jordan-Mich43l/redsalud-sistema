...
if (!empty($expediente["archivo_principal_pdf"])) {
    ...
    // Si ya viene como uploads/2026/archivo.pdf
    if (strpos($archivoPdf, "uploads/") === 0) {

        $rutaPdf = "../../" . $archivoPdf;

    } 
    // Si viene como 2026/archivo.pdf
    else {
        ...
        <section class="welcome-card">
            ...
            <div class="expediente-actions">
                ...
                <?php if ($puedeGestionarEstado): ?>
                    <form method="POST" action="cambiar_estado_expediente.php" style="display:inline-flex; align-items:center; gap:8px; margin:0;">
                        <input type="hidden" name="id_expediente" value="<?= (int)$id_expediente ?>">
                        <select name="nuevo_estado" required style="padding:8px 12px; border-radius:8px; border:1px solid #ced4da;">
                        ...
                        <button type="submit" class="btn-primary" style="padding:8px 14px;">Cambiar estado</button>
                    </form>
                <?php endif; ?>
        ...
        <div class="anexos-list">
            ...
            <?php foreach ($anexos as $anexo): ?>
                ...
                <div class="anexo-item">
                    ...
                    <a
                        href="<?= htmlspecialchars($anexo["ruta_archivo"]) ?>"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="action-link"
                    >
    ...
    <?php endif; ?>
                                        ...
                                        <div class="movement-actions">
                                            ...
                                            <form action="recibir.php" method="POST">
                                                ...
                                                <button
                                                    ...
                                                    value="RECEPCIONAR"
                                                    class="btn-primary"
                                                    onclick="return confirm('¿Confirmas que deseas RECEPCIONAR este movimiento?');"
                                                >
                                                    Recepcionar
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    value="OBSERVAR"
                                                    class="btn-secondary"
                                                    onclick="return confirm('¿Deseas marcar este movimiento como OBSERVADO?');"
                                                >
                                                    Observar
                                                </button>
            ...
            <section class="detail-card">
                ...
                <div style="padding: 16px 20px; border-bottom: 1px solid #e9ecef; background: #f8f9fa;">
                    <form method="POST" action="guardar_proveido.php" enctype="multipart/form-data" style="display:flex; flex-direction:column; gap:12px;">
                        <input type="hidden" name="id_expediente" value="<?= (int)$id_expediente ?>">
                        <label style="font-weight:600; font-size:0.9rem;">Nuevo proveído / indicación</label>
                        <textarea name="descripcion_proveido" rows="3" required maxlength="1000" placeholder="Escriba la indicación o proveído..." style="width:100%; padding:10px; border-radius:8px; border:1px solid #ced4da; resize:vertical;"></textarea>
                        <div style="display:flex; flex-wrap:wrap; gap:12px; align-items:center;">
                            <input type="file" name="archivo_proveido_pdf" accept="application/pdf,.pdf" style="font-size:0.85rem;">
                            <button type="submit" class="btn-primary" style="padding:8px 16px;">Registrar proveído</button>
                        </div>
                        <small style="color:#6c757d;">El PDF del proveído es opcional.</small>
                    </form>
                </div>
                <?php endif; ?>
                            ...
                            <article class="proveido-item">
                                ...
                                <div class="proveido-content">
                                    ...
                                    <?php if (
                                        !empty(
                                            $proveido[
                                                "archivo_proveido_pdf"
                                            ]
                                        )
                                    ): ?>

                                        <a
                                            href="<?= htmlspecialchars($proveido["archivo_proveido_pdf"]) ?>"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            class="action-link"
                                        >
