        ...
        <div class="dashboard-content">
            ...
            <section class="dashboard-section">
                ...
                <div class="section-header">
                    <div>
                        <span class="section-kicker">EXPEDIENTE</span>
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <strong>
                            <?= htmlspecialchars($expediente["tipo_documento"] ?? "Sin tipo") ?>
                        </strong>
                    </div>
                    ...
                    <div class="detail-item">
                        <span>Remitente</span>
                        <strong>
                            <?= htmlspecialchars($expediente["remitente"]) ?>
                        </strong>
                    </div>
                        ...
                        <strong>
                            <?php
                                ...
                                $claseEstado = match (strtoupper($estado)) {
                                    "EN_TRAMITE", "EN TRÁMITE" => "status-warning",
                                    "ATENDIDO", "FINALIZADO"   => "status-success",
                                    "OBSERVADO", "RECHAZADO"   => "status-danger",
                    ...
                    <div class="detail-item detail-item-wide">
                        <span>Asunto</span>
                        <strong>
                            <?= htmlspecialchars($expediente["asunto"]) ?>
                        </strong>
                    </div>
            ...
            <section class="dashboard-section">
                ...
                <div class="section-header">
                    <div>
                        <span class="section-kicker">DESTINO</span>
                        <h2>Dirección receptora</h2>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="expediente-form-grid">
                        ...
                        <div class="form-group form-group-full">
                            ...
                            ></textarea>
                            <small>Máximo 500 caracteres. Opcional.</small>
                        </div>
                    ...
                    <div class="expediente-form-actions">
                        <a
                            href="ver.php?id=<?= (int) $id_expediente ?>"
                            class="btn-secondary"
                        >
                            Cancelar
                        </a>
